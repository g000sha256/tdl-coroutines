 ...
 */
@SerialName(value = "telegramPaymentPurposePremiumGiftCodes")
@Serializable
public class TelegramPaymentPurposePremiumGiftCodes public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as TelegramPaymentPurposePremiumGiftCodes
    ...
    override fun toString(): String {
        return buildString {
            append("TelegramPaymentPurposePremiumGiftCodes")
            append("(")
