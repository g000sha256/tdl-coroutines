 ...
 */
@SerialName(value = "chatEventMemberPromoted")
@Serializable
public class ChatEventMemberPromoted public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ChatEventMemberPromoted
    ...
    override fun toString(): String {
        return buildString {
            append("ChatEventMemberPromoted")
            append("(")
            append("userId=")
            append(userId)
            append(", ")
