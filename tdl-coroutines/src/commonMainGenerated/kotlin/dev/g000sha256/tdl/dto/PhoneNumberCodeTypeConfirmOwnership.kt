 ...
 */
@SerialName(value = "phoneNumberCodeTypeConfirmOwnership")
@Serializable
public class PhoneNumberCodeTypeConfirmOwnership public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as PhoneNumberCodeTypeConfirmOwnership
    ...
    override fun toString(): String {
        return buildString {
            append("PhoneNumberCodeTypeConfirmOwnership")
            append("(")
            append("hash=")
            append(hash)
            append(")")
