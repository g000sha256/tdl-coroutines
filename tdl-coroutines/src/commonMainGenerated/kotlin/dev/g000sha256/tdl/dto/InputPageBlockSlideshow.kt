 ...
 * A slideshow.
 *
 * @property blocks Slideshow item contents.
 * @property caption Block caption; pass null if none.
 */
public class InputPageBlockSlideshow public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as InputPageBlockSlideshow
    ...
    override fun toString(): String {
        return buildString {
            append("InputPageBlockSlideshow")
            append("(")
            append("blocks=")
            blocks
                .contentDeepToString()
