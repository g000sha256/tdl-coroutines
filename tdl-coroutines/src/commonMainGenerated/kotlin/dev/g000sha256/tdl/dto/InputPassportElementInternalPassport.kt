 ...
 */
@SerialName(value = "inputPassportElementInternalPassport")
@Serializable
public class InputPassportElementInternalPassport public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as InputPassportElementInternalPassport
    ...
    override fun toString(): String {
        return buildString {
            append("InputPassportElementInternalPassport")
            append("(")
