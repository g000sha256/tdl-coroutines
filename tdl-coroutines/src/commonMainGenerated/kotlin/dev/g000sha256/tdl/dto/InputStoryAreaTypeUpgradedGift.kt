 ...
 */
@SerialName(value = "inputStoryAreaTypeUpgradedGift")
@Serializable
public class InputStoryAreaTypeUpgradedGift public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as InputStoryAreaTypeUpgradedGift
    ...
    override fun toString(): String {
        return buildString {
            append("InputStoryAreaTypeUpgradedGift")
            append("(")
            append("giftName=")
            append(giftName)
            append(")")
