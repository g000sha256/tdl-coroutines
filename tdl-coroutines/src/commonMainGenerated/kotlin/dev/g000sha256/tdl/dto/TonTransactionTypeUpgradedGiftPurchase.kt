 ...
 */
public class TonTransactionTypeUpgradedGiftPurchase public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as TonTransactionTypeUpgradedGiftPurchase
    ...
    override fun toString(): String {
        return buildString {
            append("TonTransactionTypeUpgradedGiftPurchase")
            append("(")
            append("userId=")
            append(userId)
            append(", ")
