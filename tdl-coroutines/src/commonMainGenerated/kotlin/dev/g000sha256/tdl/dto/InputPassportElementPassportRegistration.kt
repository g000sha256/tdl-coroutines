 ...
 */
@SerialName(value = "inputPassportElementPassportRegistration")
@Serializable
public class InputPassportElementPassportRegistration public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as InputPassportElementPassportRegistration
    ...
    override fun toString(): String {
        return buildString {
            append("InputPassportElementPassportRegistration")
            append("(")
