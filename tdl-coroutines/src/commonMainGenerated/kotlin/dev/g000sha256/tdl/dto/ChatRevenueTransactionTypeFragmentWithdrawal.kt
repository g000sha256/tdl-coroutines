 ...
 */
public class ChatRevenueTransactionTypeFragmentWithdrawal public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ChatRevenueTransactionTypeFragmentWithdrawal
    ...
    override fun toString(): String {
        return buildString {
            append("ChatRevenueTransactionTypeFragmentWithdrawal")
            append("(")
