 ...
 * @property message The edited message.
 */
@SerialName(value = "updateBusinessMessageEdited")
@Serializable
public class UpdateBusinessMessageEdited public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as UpdateBusinessMessageEdited
    ...
    override fun toString(): String {
        return buildString {
            append("UpdateBusinessMessageEdited")
            append("(")
            append("connectionId=")
            append(connectionId)
            append(", ")
