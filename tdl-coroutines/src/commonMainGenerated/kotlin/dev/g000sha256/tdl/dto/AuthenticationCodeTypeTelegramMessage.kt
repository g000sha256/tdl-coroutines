 ...
 */
@SerialName(value = "authenticationCodeTypeTelegramMessage")
@Serializable
public class AuthenticationCodeTypeTelegramMessage public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as AuthenticationCodeTypeTelegramMessage
    ...
    override fun toString(): String {
        return buildString {
            append("AuthenticationCodeTypeTelegramMessage")
            append("(")
            append("length=")
            append(length)
            append(")")
