 ...
 *
 * @property checklist The checklist to send.
 */
public class InputMessageChecklist public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as InputMessageChecklist
        return other.checklist == checklist
    }

    override fun hashCode(): Int {
        var hashCode = this::class.hashCode()
        hashCode = 31 * hashCode + checklist.hashCode()
        return hashCode
    }

    override fun toString(): String {
        return buildString {
            append("InputMessageChecklist")
            append("(")
            append("checklist=")
            append(checklist)
            append(")")
