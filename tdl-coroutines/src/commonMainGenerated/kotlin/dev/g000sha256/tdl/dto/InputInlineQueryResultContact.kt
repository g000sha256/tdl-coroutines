 ...
 */
@SerialName(value = "inputInlineQueryResultContact")
@Serializable
public class InputInlineQueryResultContact public constructor(
    @SerialName(value = "id")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as InputInlineQueryResultContact
        if (other.id != id) {
            return false
        }
    ...
    override fun toString(): String {
        return buildString {
            append("InputInlineQueryResultContact")
            append("(")
            append("id=")
            append(id)
            append(", ")
