 ...
 */
@SerialName(value = "reportSponsoredResultOptionRequired")
@Serializable
public class ReportSponsoredResultOptionRequired public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ReportSponsoredResultOptionRequired
    ...
    override fun toString(): String {
        return buildString {
            append("ReportSponsoredResultOptionRequired")
            append("(")
            append("title=")
            append(title)
            append(", ")
