 ...
 */
public class StarTransactionTypePaidGroupCallMessageReceive public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as StarTransactionTypePaidGroupCallMessageReceive
    ...
    override fun toString(): String {
        return buildString {
            append("StarTransactionTypePaidGroupCallMessageReceive")
            append("(")
            append("senderId=")
            append(senderId)
            append(", ")
