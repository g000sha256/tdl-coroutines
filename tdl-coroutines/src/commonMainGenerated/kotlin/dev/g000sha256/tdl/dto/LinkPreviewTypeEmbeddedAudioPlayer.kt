 ...
 * @property audio The cached audio; may be null if unknown.
 ...
 */
public class LinkPreviewTypeEmbeddedAudioPlayer public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as LinkPreviewTypeEmbeddedAudioPlayer
        if (other.url != url) {
            return false
        }
    ...
    override fun toString(): String {
        return buildString {
            append("LinkPreviewTypeEmbeddedAudioPlayer")
            append("(")
            append("url=")
            append(url)
            append(", ")
