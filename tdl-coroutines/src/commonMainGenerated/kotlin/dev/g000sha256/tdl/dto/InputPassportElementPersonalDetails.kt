 ...
 */
@SerialName(value = "inputPassportElementPersonalDetails")
@Serializable
public class InputPassportElementPersonalDetails public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as InputPassportElementPersonalDetails
    ...
    override fun toString(): String {
        return buildString {
            append("InputPassportElementPersonalDetails")
            append("(")
