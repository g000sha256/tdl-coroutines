 ...
 *
 * @property models Models that can be chosen for the gift after upgrade.
 * @property symbols Symbols that can be chosen for the gift after upgrade.
 * @property backdrops Backdrops that can be chosen for the gift after upgrade.
 */
public class GiftUpgradeVariants public constructor(
