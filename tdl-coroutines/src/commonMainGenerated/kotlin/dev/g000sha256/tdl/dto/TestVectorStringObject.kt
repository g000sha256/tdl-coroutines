 ...
 */
@SerialName(value = "testVectorStringObject")
@Serializable
public class TestVectorStringObject public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as TestVectorStringObject
