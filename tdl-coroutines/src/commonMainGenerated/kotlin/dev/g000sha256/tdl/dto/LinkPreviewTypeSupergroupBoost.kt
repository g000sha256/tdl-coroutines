 ...
 */
@SerialName(value = "linkPreviewTypeSupergroupBoost")
@Serializable
public class LinkPreviewTypeSupergroupBoost public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as LinkPreviewTypeSupergroupBoost
    ...
    override fun toString(): String {
        return buildString {
            append("LinkPreviewTypeSupergroupBoost")
            append("(")
            append("photo=")
            append(photo)
            append(")")
