 ...
 */
public class StarTransactionTypeGiftUpgradePurchase public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as StarTransactionTypeGiftUpgradePurchase
    ...
    override fun toString(): String {
        return buildString {
            append("StarTransactionTypeGiftUpgradePurchase")
            append("(")
            append("ownerId=")
            append(ownerId)
            append(", ")
