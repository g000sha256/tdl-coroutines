 ...
 */
public class StarTransactionTypeGiftPurchaseOffer public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as StarTransactionTypeGiftPurchaseOffer
    ...
    override fun toString(): String {
        return buildString {
            append("StarTransactionTypeGiftPurchaseOffer")
            append("(")
            append("gift=")
            append(gift)
            append(")")
