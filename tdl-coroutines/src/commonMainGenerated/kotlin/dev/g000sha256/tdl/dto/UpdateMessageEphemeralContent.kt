 ...
 * @property ephemeralContent New ephemeral content of the message; may be null if none.
 */
public class UpdateMessageEphemeralContent public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as UpdateMessageEphemeralContent
        ...
        return other.ephemeralContent == ephemeralContent
    }
    ...
    override fun toString(): String {
        return buildString {
            append("UpdateMessageEphemeralContent")
            append("(")
            append("chatId=")
            append(chatId)
            append(", ")
