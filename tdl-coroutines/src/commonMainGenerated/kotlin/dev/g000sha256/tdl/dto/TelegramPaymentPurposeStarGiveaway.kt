 ...
 */
@SerialName(value = "telegramPaymentPurposeStarGiveaway")
@Serializable
public class TelegramPaymentPurposeStarGiveaway public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as TelegramPaymentPurposeStarGiveaway
    ...
    override fun toString(): String {
        return buildString {
            append("TelegramPaymentPurposeStarGiveaway")
            append("(")
            append("parameters=")
            append(parameters)
            append(", ")
