 ...
 */
@SerialName(value = "reportStoryResultOptionRequired")
@Serializable
public class ReportStoryResultOptionRequired public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ReportStoryResultOptionRequired
    ...
    override fun toString(): String {
        return buildString {
            append("ReportStoryResultOptionRequired")
            append("(")
            append("title=")
            append(title)
            append(", ")
