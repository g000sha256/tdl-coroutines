 ...
 */
@SerialName(value = "updateNewBusinessCallbackQuery")
@Serializable
public class UpdateNewBusinessCallbackQuery public constructor(
    @SerialName(value = "id")
    public val id: Long,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as UpdateNewBusinessCallbackQuery
        if (other.id != id) {
            return false
        }
    ...
    override fun toString(): String {
        return buildString {
            append("UpdateNewBusinessCallbackQuery")
            append("(")
            append("id=")
            append(id)
            append(", ")
