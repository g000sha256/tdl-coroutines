 ...
 *
 * @property userId Identifier of the user who sent Telegram Stars.
 */
public class StarTransactionTypeBusinessBotTransferReceive public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as StarTransactionTypeBusinessBotTransferReceive
    ...
    override fun toString(): String {
        return buildString {
            append("StarTransactionTypeBusinessBotTransferReceive")
            append("(")
            append("userId=")
            append(userId)
            append(")")
