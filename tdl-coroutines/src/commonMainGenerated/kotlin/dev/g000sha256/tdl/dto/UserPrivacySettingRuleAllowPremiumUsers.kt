 ...
 */
@SerialName(value = "userPrivacySettingRuleAllowPremiumUsers")
@Serializable
public class UserPrivacySettingRuleAllowPremiumUsers public constructor() : UserPrivacySettingRule() {
