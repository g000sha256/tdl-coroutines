 ...
 */
@SerialName(value = "pushMessageContentGame")
@Serializable
public class PushMessageContentGame public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as PushMessageContentGame
