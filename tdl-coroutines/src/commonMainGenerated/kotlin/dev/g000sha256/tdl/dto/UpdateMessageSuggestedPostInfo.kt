 ...
 * @property suggestedPostInfo The new information about the suggested post.
 */
public class UpdateMessageSuggestedPostInfo public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as UpdateMessageSuggestedPostInfo
    ...
    override fun toString(): String {
        return buildString {
            append("UpdateMessageSuggestedPostInfo")
            append("(")
            append("chatId=")
            append(chatId)
            append(", ")
