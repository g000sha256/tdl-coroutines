 ...
 */
@SerialName(value = "telegramPaymentPurposeGiftedStars")
@Serializable
public class TelegramPaymentPurposeGiftedStars public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as TelegramPaymentPurposeGiftedStars
    ...
    override fun toString(): String {
        return buildString {
            append("TelegramPaymentPurposeGiftedStars")
            append("(")
            append("userId=")
            append(userId)
            append(", ")
