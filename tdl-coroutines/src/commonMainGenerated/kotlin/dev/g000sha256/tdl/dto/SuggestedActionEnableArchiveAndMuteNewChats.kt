 ...
 */
@SerialName(value = "suggestedActionEnableArchiveAndMuteNewChats")
@Serializable
public class SuggestedActionEnableArchiveAndMuteNewChats public constructor() : SuggestedAction() {
