 ...
 */
@SerialName(value = "passportElementPassportRegistration")
@Serializable
public class PassportElementPassportRegistration public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as PassportElementPassportRegistration
    ...
    override fun toString(): String {
        return buildString {
            append("PassportElementPassportRegistration")
            append("(")
