 ...
 */
@SerialName(value = "starTransactionTypeChannelPaidReactionSend")
@Serializable
public class StarTransactionTypeChannelPaidReactionSend public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as StarTransactionTypeChannelPaidReactionSend
    ...
    override fun toString(): String {
        return buildString {
            append("StarTransactionTypeChannelPaidReactionSend")
            append("(")
            append("chatId=")
            append(chatId)
            append(", ")
