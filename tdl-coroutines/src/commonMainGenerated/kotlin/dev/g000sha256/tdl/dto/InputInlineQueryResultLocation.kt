 ...
 */
@SerialName(value = "inputInlineQueryResultLocation")
@Serializable
public class InputInlineQueryResultLocation public constructor(
    @SerialName(value = "id")
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as InputInlineQueryResultLocation
        if (other.id != id) {
            return false
        }
    ...
    override fun toString(): String {
        return buildString {
            append("InputInlineQueryResultLocation")
            append("(")
            append("id=")
            append(id)
            append(", ")
