 ...
 */
public class TonTransactionTypeFragmentWithdrawal public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as TonTransactionTypeFragmentWithdrawal
    ...
    override fun toString(): String {
        return buildString {
            append("TonTransactionTypeFragmentWithdrawal")
            append("(")
