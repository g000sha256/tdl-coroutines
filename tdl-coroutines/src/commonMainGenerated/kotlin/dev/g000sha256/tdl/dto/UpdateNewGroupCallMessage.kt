 ...
 */
public class UpdateNewGroupCallMessage public constructor(
    public val groupCallId: Int,
    public val message: GroupCallMessage,
) : Update() {
    override fun equals(other: Any?): Boolean {
        ...
        other as UpdateNewGroupCallMessage
    ...
    override fun toString(): String {
        return buildString {
            append("UpdateNewGroupCallMessage")
            append("(")
            append("groupCallId=")
            append(groupCallId)
            append(", ")
