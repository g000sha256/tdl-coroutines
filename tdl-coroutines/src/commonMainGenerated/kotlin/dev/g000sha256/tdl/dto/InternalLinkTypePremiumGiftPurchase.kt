 ...
 */
public class InternalLinkTypePremiumGiftPurchase public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as InternalLinkTypePremiumGiftPurchase
    ...
    override fun toString(): String {
        return buildString {
            append("InternalLinkTypePremiumGiftPurchase")
            append("(")
            append("referrer=")
            append(referrer)
            append(")")
