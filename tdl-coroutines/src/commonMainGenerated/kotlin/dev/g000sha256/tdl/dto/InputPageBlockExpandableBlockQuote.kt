 ...
 */
public class InputPageBlockExpandableBlockQuote public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as InputPageBlockExpandableBlockQuote
        if (other.text != text) {
            return false
        }
    ...
    override fun toString(): String {
        return buildString {
            append("InputPageBlockExpandableBlockQuote")
            append("(")
            append("text=")
            append(text)
            append(", ")
