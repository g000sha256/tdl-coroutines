 ...
 *
 * @property userId Identifier of the user who added the paid reaction.
...
public class StarTransactionTypeChannelPaidReactionReceive public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as StarTransactionTypeChannelPaidReactionReceive
    ...
    override fun toString(): String {
        return buildString {
            append("StarTransactionTypeChannelPaidReactionReceive")
            append("(")
            append("userId=")
            append(userId)
            append(", ")
