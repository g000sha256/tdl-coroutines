 ...
 */
public class UpdateGroupCallMessagesDeleted public constructor(
    public val groupCallId: Int,
    public val messageIds: IntArray,
) : Update() {
    override fun equals(other: Any?): Boolean {
        ...
        other as UpdateGroupCallMessagesDeleted
    ...
    override fun toString(): String {
        return buildString {
            append("UpdateGroupCallMessagesDeleted")
            append("(")
            append("groupCallId=")
            append(groupCallId)
            append(", ")
