 ...
 */
@SerialName(value = "pushMessageContentContact")
@Serializable
public class PushMessageContentContact public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as PushMessageContentContact
        if (other.name != name) {
            return false
        }
    ...
    override fun toString(): String {
        return buildString {
            append("PushMessageContentContact")
            append("(")
            append("name=")
            append(name)
            append(", ")
