 ...
 */
@SerialName(value = "pushMessageContentText")
@Serializable
public class PushMessageContentText public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as PushMessageContentText
        if (other.text != text) {
            return false
        }
