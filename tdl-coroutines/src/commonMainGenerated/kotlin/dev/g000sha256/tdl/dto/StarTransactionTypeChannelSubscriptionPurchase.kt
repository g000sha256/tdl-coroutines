 ...
 */
@SerialName(value = "starTransactionTypeChannelSubscriptionPurchase")
@Serializable
public class StarTransactionTypeChannelSubscriptionPurchase public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as StarTransactionTypeChannelSubscriptionPurchase
    ...
    override fun toString(): String {
        return buildString {
            append("StarTransactionTypeChannelSubscriptionPurchase")
            append("(")
            append("chatId=")
            append(chatId)
            append(", ")
