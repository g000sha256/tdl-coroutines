 ...
 */
@SerialName(value = "chatEventVideoChatCreated")
@Serializable
public class ChatEventVideoChatCreated public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ChatEventVideoChatCreated
    ...
    override fun toString(): String {
        return buildString {
            append("ChatEventVideoChatCreated")
            append("(")
            append("groupCallId=")
            append(groupCallId)
            append(")")
