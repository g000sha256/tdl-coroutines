...
internal class SendEphemeralMessage internal constructor(
    internal val chatId: Long,
    internal val topicId: MessageTopic?,
    internal val receiverUserId: Long,
    internal val callbackQueryId: Long,
    internal val replaceCallbackQueryMessage: Boolean,
    internal val replyTo: InputMessageReplyTo?,
    internal val protectContent: Boolean,
    internal val sendingId: Int,
    internal val onlyPreview: Boolean,
