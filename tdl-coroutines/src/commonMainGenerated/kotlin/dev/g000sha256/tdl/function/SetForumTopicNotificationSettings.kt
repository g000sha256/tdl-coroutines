...
@SerialName(value = "setForumTopicNotificationSettings")
@Serializable
internal class SetForumTopicNotificationSettings internal constructor(
    ...
    internal val notificationSettings: ChatNotificationSettings,
) : Function()
