...
@SerialName(value = "searchAffiliatePrograms")
@Serializable
internal class SearchAffiliatePrograms internal constructor(
    @SerialName(value = "affiliate")
    internal val affiliate: AffiliateType,
    @SerialName(value = "sort_order")
    internal val sortOrder: AffiliateProgramSortOrder,
