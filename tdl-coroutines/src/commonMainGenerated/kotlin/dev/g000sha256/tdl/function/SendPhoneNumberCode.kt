...
@SerialName(value = "sendPhoneNumberCode")
@Serializable
internal class SendPhoneNumberCode internal constructor(
    @SerialName(value = "phone_number")
    internal val phoneNumber: String,
    @SerialName(value = "settings")
    internal val settings: PhoneNumberAuthenticationSettings?,
    @SerialName(value = "type")
    internal val type: PhoneNumberCodeType,
) : Function()
