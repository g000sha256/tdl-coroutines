...
@SerialName(value = "upgradeGift")
@Serializable
internal class UpgradeGift internal constructor(
    ...
    @SerialName(value = "keep_original_details")
    internal val keepOriginalDetails: Boolean,
