...
@SerialName(value = "editMessageSchedulingState")
@Serializable
internal class EditMessageSchedulingState internal constructor(
    @SerialName(value = "chat_id")
    internal val chatId: Long,
    @SerialName(value = "message_id")
    internal val messageId: Long,
    @SerialName(value = "scheduling_state")
    internal val schedulingState: MessageSchedulingState?,
) : Function()
