 ...
 */
public sealed class ReportChatResultDto private constructor() {
    /**
     * The chat was reported successfully.
     */
    public class Ok public constructor() : ReportChatResultDto() {
    ...
    public class OptionRequired public constructor(
        ...
        override fun toString(): String {
            return buildString {
                append("ReportChatResultDto.OptionRequired")
                append("(")
                append("title=")
                append(title)
                append(", ")
    ...
    public class TextRequired public constructor(
        ...
        override fun toString(): String {
            return buildString {
                append("ReportChatResultDto.TextRequired")
                append("(")
                append("optionId=")
                optionId
                    .contentToString()
     ...
     */
    public class MessagesRequired public constructor() : ReportChatResultDto() {
        override fun equals(other: Any?): Boolean {
            if (other === this) {
                return true
            }
