 ...
 */
public class ChatDto public constructor(
    public val id: Long,
    public val type: ChatTypeDto,
    ...
    public val chatLists: Array<ChatListDto>,
    public val messageSenderId: MessageSenderDto?,
    ...
    public val notificationSettings: ChatNotificationSettingsDto,
    public val availableReactions: ChatAvailableReactionsDto,
    public val messageAutoDeleteTime: Int,
    public val emojiStatus: EmojiStatusDto?,
    public val background: ChatBackgroundDto?,
    public val themeName: String,
    public val actionBar: ChatActionBarDto?,
    public val businessBotManageBar: BusinessBotManageBarDto?,
    public val videoChat: VideoChatDto,
    public val pendingJoinRequests: ChatJoinRequestsInfoDto?,
