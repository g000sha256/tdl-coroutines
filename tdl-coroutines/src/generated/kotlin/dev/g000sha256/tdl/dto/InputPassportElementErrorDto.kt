 ...
 */
public class InputPassportElementErrorDto public constructor(
    public val type: PassportElementTypeDto,
    public val message: String,
    public val source: InputPassportElementErrorSourceDto,
) {
    override fun equals(other: Any?): Boolean {
        ...
        other as InputPassportElementErrorDto
        if (other.type != type) {
            return false
        }
    ...
    override fun toString(): String {
        return buildString {
            append("InputPassportElementErrorDto")
            append("(")
            append("type=")
            append(type)
            append(", ")
