 ...
 */
public class MessageDto public constructor(
    public val id: Long,
    public val senderId: MessageSenderDto,
    public val chatId: Long,
    public val sendingState: MessageSendingStateDto?,
    public val schedulingState: MessageSchedulingStateDto?,
    ...
    public val forwardInfo: MessageForwardInfoDto?,
    public val importInfo: MessageImportInfoDto?,
    public val interactionInfo: MessageInteractionInfoDto?,
    public val unreadReactions: Array<UnreadReactionDto>,
    public val factCheck: FactCheckDto?,
    public val replyTo: MessageReplyToDto?,
