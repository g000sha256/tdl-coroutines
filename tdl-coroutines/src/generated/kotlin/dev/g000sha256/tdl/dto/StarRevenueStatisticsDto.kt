 ...
 */
public class StarRevenueStatisticsDto public constructor(
    public val revenueByDayGraph: StatisticalGraphDto,
    public val status: StarRevenueStatusDto,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as StarRevenueStatisticsDto
    ...
    override fun toString(): String {
        return buildString {
            append("StarRevenueStatisticsDto")
            append("(")
