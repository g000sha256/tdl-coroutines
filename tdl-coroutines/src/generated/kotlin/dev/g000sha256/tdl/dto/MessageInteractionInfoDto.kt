 ...
 */
public class MessageInteractionInfoDto public constructor(
    public val viewCount: Int,
    public val forwardCount: Int,
    public val replyInfo: MessageReplyInfoDto?,
    public val reactions: MessageReactionsDto?,
) {
    override fun equals(other: Any?): Boolean {
        ...
        other as MessageInteractionInfoDto
    ...
    override fun toString(): String {
        return buildString {
            append("MessageInteractionInfoDto")
            append("(")
            append("viewCount=")
            append(viewCount)
            append(", ")
