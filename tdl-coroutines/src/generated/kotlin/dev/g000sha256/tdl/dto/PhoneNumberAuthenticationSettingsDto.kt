 ...
 */
public class PhoneNumberAuthenticationSettingsDto public constructor(
    ...
    public val firebaseAuthenticationSettings: FirebaseAuthenticationSettingsDto?,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as PhoneNumberAuthenticationSettingsDto
    ...
    override fun toString(): String {
        return buildString {
            append("PhoneNumberAuthenticationSettingsDto")
            append("(")
