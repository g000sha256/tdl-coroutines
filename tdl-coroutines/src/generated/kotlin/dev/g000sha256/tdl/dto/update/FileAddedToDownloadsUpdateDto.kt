 ...
 */
public class FileAddedToDownloadsUpdateDto public constructor(
    public val fileDownload: FileDownloadDto,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as FileAddedToDownloadsUpdateDto
    ...
    override fun toString(): String {
        return buildString {
            append("FileAddedToDownloadsUpdateDto")
            append("(")
            append("fileDownload=")
            append(fileDownload)
            append(", ")
