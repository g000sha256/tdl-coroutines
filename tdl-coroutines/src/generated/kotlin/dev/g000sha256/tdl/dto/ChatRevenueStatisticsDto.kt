 ...
 */
public class ChatRevenueStatisticsDto public constructor(
    public val revenueByHourGraph: StatisticalGraphDto,
    public val revenueGraph: StatisticalGraphDto,
    public val revenueAmount: ChatRevenueAmountDto,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ChatRevenueStatisticsDto
    ...
    override fun toString(): String {
        return buildString {
            append("ChatRevenueStatisticsDto")
            append("(")
