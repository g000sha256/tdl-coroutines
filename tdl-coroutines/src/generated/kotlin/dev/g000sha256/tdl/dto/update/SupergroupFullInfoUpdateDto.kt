 ...
 */
public class SupergroupFullInfoUpdateDto public constructor(
    public val supergroupId: Long,
    public val supergroupFullInfo: SupergroupFullInfoDto,
) : UpdateDto() {
    override fun equals(other: Any?): Boolean {
        ...
        other as SupergroupFullInfoUpdateDto
        if (other.supergroupId != supergroupId) {
            return false
        }
        return other.supergroupFullInfo == supergroupFullInfo
    }

    override fun hashCode(): Int {
        var hashCode = this::class.hashCode()
        hashCode = 31 * hashCode + supergroupId.hashCode()
        hashCode = 31 * hashCode + supergroupFullInfo.hashCode()
        return hashCode
    }

    override fun toString(): String {
        return buildString {
            append("SupergroupFullInfoUpdateDto")
            append("(")
            append("supergroupId=")
            append(supergroupId)
            append(", ")
