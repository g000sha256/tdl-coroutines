 ...
 */
public class PremiumFeaturePromotionAnimationDto public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as PremiumFeaturePromotionAnimationDto
    ...
    override fun toString(): String {
        return buildString {
            append("PremiumFeaturePromotionAnimationDto")
            append("(")
            append("feature=")
            append(feature)
            append(", ")
