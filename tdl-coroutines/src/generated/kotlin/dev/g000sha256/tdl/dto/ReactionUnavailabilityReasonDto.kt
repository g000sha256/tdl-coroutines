 ...
 */
public sealed class ReactionUnavailabilityReasonDto private constructor() {
    /**
     ...
     */
    public class AnonymousAdministrator public constructor() : ReactionUnavailabilityReasonDto() {
     ...
     */
    public class Guest public constructor() : ReactionUnavailabilityReasonDto() {
        override fun equals(other: Any?): Boolean {
            if (other === this) {
                return true
            }
