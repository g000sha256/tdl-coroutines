 ...
 */
public class ReactionNotificationSettingsUpdateDto public constructor(
    public val notificationSettings: ReactionNotificationSettingsDto,
) : UpdateDto() {
    override fun equals(other: Any?): Boolean {
        ...
        other as ReactionNotificationSettingsUpdateDto
    ...
    override fun toString(): String {
        return buildString {
            append("ReactionNotificationSettingsUpdateDto")
            append("(")
