 ...
 */
public class EmojiCategoryDto public constructor(
    public val name: String,
    public val icon: StickerDto,
    public val source: EmojiCategorySourceDto,
