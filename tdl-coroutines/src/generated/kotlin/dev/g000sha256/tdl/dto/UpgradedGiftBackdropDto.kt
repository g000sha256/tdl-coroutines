 ...
 */
public class UpgradedGiftBackdropDto public constructor(
    public val name: String,
    public val colors: UpgradedGiftBackdropColorsDto,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as UpgradedGiftBackdropDto
        if (other.name != name) {
            return false
        }
    ...
    override fun toString(): String {
        return buildString {
            append("UpgradedGiftBackdropDto")
            append("(")
            append("name=")
            append(name)
            append(", ")
