 ...
 */
public class PassportAuthorizationFormDto public constructor(
    public val id: Int,
    public val requiredElements: Array<PassportRequiredElementDto>,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as PassportAuthorizationFormDto
        if (other.id != id) {
            return false
        }
    ...
    override fun toString(): String {
        return buildString {
            append("PassportAuthorizationFormDto")
            append("(")
            append("id=")
            append(id)
            append(", ")
