 ...
 */
public class FileGenerationStopUpdateDto public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as FileGenerationStopUpdateDto
        return other.generationId == generationId
    }
    ...
    override fun toString(): String {
        return buildString {
            append("FileGenerationStopUpdateDto")
            append("(")
            append("generationId=")
            append(generationId)
            append(")")
