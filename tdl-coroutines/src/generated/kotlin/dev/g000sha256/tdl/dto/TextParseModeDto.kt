 ...
 */
public sealed class TextParseModeDto private constructor() {
    /**
     ...
     */
    public class Markdown public constructor(
        ...
        override fun toString(): String {
            return buildString {
                append("TextParseModeDto.Markdown")
                append("(")
                append("version=")
                append(version)
                append(")")
     ...
     */
    public class HTML public constructor() : TextParseModeDto() {
        override fun equals(other: Any?): Boolean {
            if (other === this) {
                return true
            }
