 ...
 */
public class ChatHasScheduledMessagesUpdateDto public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ChatHasScheduledMessagesUpdateDto
        if (other.chatId != chatId) {
            return false
        }
        return other.hasScheduledMessages == hasScheduledMessages
    }
    ...
    override fun toString(): String {
        return buildString {
            append("ChatHasScheduledMessagesUpdateDto")
            append("(")
            append("chatId=")
            append(chatId)
            append(", ")
