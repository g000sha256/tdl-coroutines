 ...
 */
public sealed class NetworkStatisticsEntryDto private constructor() {
    /**
    ...
    public class File public constructor(
        ...
        public val networkType: NetworkTypeDto,
        public val sentBytes: Long,
        public val receivedBytes: Long,
    ) : NetworkStatisticsEntryDto() {
        ...
        override fun toString(): String {
            return buildString {
                append("NetworkStatisticsEntryDto.File")
                append("(")
                append("fileType=")
                append(fileType)
                append(", ")
    ...
    public class Call public constructor(
        ...
        override fun toString(): String {
            return buildString {
                append("NetworkStatisticsEntryDto.Call")
                append("(")
                append("networkType=")
                append(networkType)
                append(", ")
