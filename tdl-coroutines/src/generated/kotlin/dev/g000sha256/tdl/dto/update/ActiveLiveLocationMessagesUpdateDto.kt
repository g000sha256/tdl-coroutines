 ...
 */
public class ActiveLiveLocationMessagesUpdateDto public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ActiveLiveLocationMessagesUpdateDto
    ...
    override fun toString(): String {
        return buildString {
            append("ActiveLiveLocationMessagesUpdateDto")
            append("(")
            append("messages=")
            messages
                .contentDeepToString()
