 ...
 * @property expirationDate Document expiration date; pass null if not applicable.
 * @property frontSide Front side of the document.
 * @property reverseSide Reverse side of the document; only for driver license and identity card; pass null otherwise.
 ...
 */
public class InputIdentityDocumentDto public constructor(
    public val number: String,
    public val expirationDate: DateDto?,
    public val frontSide: InputFileDto,
    public val reverseSide: InputFileDto?,
    public val selfie: InputFileDto?,
    public val translation: Array<InputFileDto>,
) {
    override fun equals(other: Any?): Boolean {
        ...
        other as InputIdentityDocumentDto
    ...
    override fun toString(): String {
        return buildString {
            append("InputIdentityDocumentDto")
            append("(")
            append("number=")
            append(number)
            append(", ")
