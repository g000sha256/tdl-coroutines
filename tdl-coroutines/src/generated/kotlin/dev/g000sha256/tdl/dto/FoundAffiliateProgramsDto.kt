 ...
 *
 * @property totalCount The total number of found affiliate programs.
 ...
 */
public class FoundAffiliateProgramsDto public constructor(
    public val totalCount: Int,
    public val programs: Array<FoundAffiliateProgramDto>,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as FoundAffiliateProgramsDto
    ...
    override fun toString(): String {
        return buildString {
            append("FoundAffiliateProgramsDto")
            append("(")
            append("totalCount=")
            append(totalCount)
            append(", ")
