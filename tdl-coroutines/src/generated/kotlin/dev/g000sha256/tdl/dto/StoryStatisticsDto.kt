 ...
 */
public class StoryStatisticsDto public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as StoryStatisticsDto
        if (other.storyInteractionGraph != storyInteractionGraph) {
            return false
        }
        return other.storyReactionGraph == storyReactionGraph
    }
