 ...
 */
public sealed class SearchMessagesChatTypeFilterDto private constructor() {
    /**
     * Returns only messages in private chats.
     */
    public class Private public constructor() : SearchMessagesChatTypeFilterDto() {
     ...
     */
    public class Group public constructor() : SearchMessagesChatTypeFilterDto() {
        override fun equals(other: Any?): Boolean {
            if (other === this) {
                return true
            }
     ...
     */
    public class Channel public constructor() : SearchMessagesChatTypeFilterDto() {
        override fun equals(other: Any?): Boolean {
            if (other === this) {
                return true
            }
