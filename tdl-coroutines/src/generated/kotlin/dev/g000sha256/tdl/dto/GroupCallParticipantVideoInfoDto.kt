 ...
 */
public class GroupCallParticipantVideoInfoDto public constructor(
    public val sourceGroups: Array<GroupCallVideoSourceGroupDto>,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as GroupCallParticipantVideoInfoDto
    ...
    override fun toString(): String {
        return buildString {
            append("GroupCallParticipantVideoInfoDto")
            append("(")
            append("sourceGroups=")
            sourceGroups
                .contentDeepToString()
