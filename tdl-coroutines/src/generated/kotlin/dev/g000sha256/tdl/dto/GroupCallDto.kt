 ...
 * @property inviteLink Invite link for the group call; for group calls that aren't bound to a chat. For video chats call getVideoChatInviteLink to get the link.
 ...
 * @property isRtmpStream True, if the call is an RTMP stream instead of an ordinary video chat; for video chats only.
 ...
 * @property canBeManaged True, if the current user can manage the group call; for video chats only.
 ...
 */
public class GroupCallDto public constructor(
    public val id: Int,
    ...
    public val recentSpeakers: Array<GroupCallRecentSpeakerDto>,
