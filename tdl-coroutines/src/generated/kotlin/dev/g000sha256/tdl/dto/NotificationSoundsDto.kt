 ...
 */
public class NotificationSoundsDto public constructor(
    public val notificationSounds: Array<NotificationSoundDto>,
) {
    override fun equals(other: Any?): Boolean {
        ...
        other as NotificationSoundsDto
