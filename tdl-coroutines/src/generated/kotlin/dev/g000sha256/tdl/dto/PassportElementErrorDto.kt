 ...
 */
public class PassportElementErrorDto public constructor(
    public val type: PassportElementTypeDto,
    public val message: String,
    public val source: PassportElementErrorSourceDto,
) {
    override fun equals(other: Any?): Boolean {
        ...
        other as PassportElementErrorDto
        if (other.type != type) {
            return false
        }
    ...
    override fun toString(): String {
        return buildString {
            append("PassportElementErrorDto")
            append("(")
            append("type=")
            append(type)
            append(", ")
