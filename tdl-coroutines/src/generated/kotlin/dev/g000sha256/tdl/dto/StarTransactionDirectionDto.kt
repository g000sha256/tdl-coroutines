 ...
 */
public sealed class StarTransactionDirectionDto private constructor() {
    /**
     * The transaction is incoming and increases the number of owned Telegram Stars.
     */
    public class Incoming public constructor() : StarTransactionDirectionDto() {
     ...
     */
    public class Outgoing public constructor() : StarTransactionDirectionDto() {
        override fun equals(other: Any?): Boolean {
            if (other === this) {
                return true
            }
