 ...
 */
public class StickerSetsDto public constructor(
    public val totalCount: Int,
    public val sets: Array<StickerSetInfoDto>,
) {
    override fun equals(other: Any?): Boolean {
        ...
        other as StickerSetsDto
        if (other.totalCount != totalCount) {
            return false
        }
        return other.sets.contentDeepEquals(sets)
    }
