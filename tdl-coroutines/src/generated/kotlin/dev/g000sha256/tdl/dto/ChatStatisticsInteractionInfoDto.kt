 ...
 */
public class ChatStatisticsInteractionInfoDto public constructor(
    public val objectType: ChatStatisticsObjectTypeDto,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ChatStatisticsInteractionInfoDto
    ...
    override fun toString(): String {
        return buildString {
            append("ChatStatisticsInteractionInfoDto")
            append("(")
            append("objectType=")
            append(objectType)
            append(", ")
