 ...
 */
public class GroupCallRecentSpeakerDto public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as GroupCallRecentSpeakerDto
        if (other.participantId != participantId) {
            return false
        }
        return other.isSpeaking == isSpeaking
    }
    ...
    override fun toString(): String {
        return buildString {
            append("GroupCallRecentSpeakerDto")
            append("(")
