 ...
 */
public class ChatRevenueTransactionsDto public constructor(
    public val totalCount: Int,
    public val transactions: Array<ChatRevenueTransactionDto>,
) {
    override fun equals(other: Any?): Boolean {
        ...
        other as ChatRevenueTransactionsDto
    ...
    override fun toString(): String {
        return buildString {
            append("ChatRevenueTransactionsDto")
            append("(")
            append("totalCount=")
            append(totalCount)
            append(", ")
