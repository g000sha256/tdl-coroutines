 ...
 */
public class ChatRevenueTransactionDto public constructor(
    public val cryptocurrency: String,
    public val cryptocurrencyAmount: Long,
    public val type: ChatRevenueTransactionTypeDto,
) {
    override fun equals(other: Any?): Boolean {
        ...
        other as ChatRevenueTransactionDto
    ...
    override fun toString(): String {
        return buildString {
            append("ChatRevenueTransactionDto")
            append("(")
