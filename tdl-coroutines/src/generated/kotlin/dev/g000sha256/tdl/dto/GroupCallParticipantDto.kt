 ...
 */
public class GroupCallParticipantDto public constructor(
    public val participantId: MessageSenderDto,
    public val audioSourceId: Int,
    public val screenSharingAudioSourceId: Int,
    public val videoInfo: GroupCallParticipantVideoInfoDto?,
    public val screenSharingVideoInfo: GroupCallParticipantVideoInfoDto?,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as GroupCallParticipantDto
    ...
    override fun toString(): String {
        return buildString {
            append("GroupCallParticipantDto")
            append("(")
