 ...
 */
public class ChatMessageSenderUpdateDto public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ChatMessageSenderUpdateDto
        if (other.chatId != chatId) {
            return false
        }
        return other.messageSenderId == messageSenderId
    }
    ...
    override fun toString(): String {
        return buildString {
            append("ChatMessageSenderUpdateDto")
            append("(")
            append("chatId=")
            append(chatId)
            append(", ")
