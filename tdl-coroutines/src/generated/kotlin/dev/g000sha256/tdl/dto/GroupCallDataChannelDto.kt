 ...
 */
public sealed class GroupCallDataChannelDto private constructor() {
    /**
     * The main data channel for audio and video data.
     */
    public class Main public constructor() : GroupCallDataChannelDto() {
     ...
     */
    public class ScreenSharing public constructor() : GroupCallDataChannelDto() {
        override fun equals(other: Any?): Boolean {
            if (other === this) {
                return true
            }
