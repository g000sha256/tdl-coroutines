 ...
 */
public class LanguagePackStringDto public constructor(
    public val key: String,
    public val value: LanguagePackStringValueDto?,
) {
    override fun equals(other: Any?): Boolean {
        ...
        other as LanguagePackStringDto
        if (other.key != key) {
            return false
        }
