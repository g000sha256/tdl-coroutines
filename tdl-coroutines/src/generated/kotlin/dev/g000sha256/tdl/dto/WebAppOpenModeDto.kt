 ...
 */
public sealed class WebAppOpenModeDto private constructor() {
    /**
     * The Web App is opened in the compact mode.
     */
    public class Compact public constructor() : WebAppOpenModeDto() {
     ...
     */
    public class FullSize public constructor() : WebAppOpenModeDto() {
        override fun equals(other: Any?): Boolean {
            if (other === this) {
                return true
            }
     ...
     */
    public class FullScreen public constructor() : WebAppOpenModeDto() {
        override fun equals(other: Any?): Boolean {
            if (other === this) {
                return true
            }
