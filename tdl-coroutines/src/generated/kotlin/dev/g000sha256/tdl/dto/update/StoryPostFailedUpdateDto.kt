 ...
 */
public class StoryPostFailedUpdateDto public constructor(
    public val story: StoryDto,
    public val error: ErrorDto,
    public val errorType: CanPostStoryResultDto?,
) : UpdateDto() {
    override fun equals(other: Any?): Boolean {
        ...
        other as StoryPostFailedUpdateDto
    ...
    override fun toString(): String {
        return buildString {
            append("StoryPostFailedUpdateDto")
            append("(")
            append("story=")
            append(story)
            append(", ")
