 ...
 */
public class CreatedBasicGroupChatDto public constructor(
    public val chatId: Long,
    public val failedToAddMembers: FailedToAddMembersDto,
) {
    override fun equals(other: Any?): Boolean {
        ...
        other as CreatedBasicGroupChatDto
    ...
    override fun toString(): String {
        return buildString {
            append("CreatedBasicGroupChatDto")
            append("(")
            append("chatId=")
            append(chatId)
            append(", ")
