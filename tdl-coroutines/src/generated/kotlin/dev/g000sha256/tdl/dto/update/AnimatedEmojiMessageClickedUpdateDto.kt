 ...
 */
public class AnimatedEmojiMessageClickedUpdateDto public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as AnimatedEmojiMessageClickedUpdateDto
    ...
    override fun toString(): String {
        return buildString {
            append("AnimatedEmojiMessageClickedUpdateDto")
            append("(")
            append("chatId=")
            append(chatId)
            append(", ")
