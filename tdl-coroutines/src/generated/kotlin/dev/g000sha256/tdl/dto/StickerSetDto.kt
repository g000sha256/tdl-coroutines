 ...
 */
public class StickerSetDto public constructor(
    public val id: Long,
    public val title: String,
    public val name: String,
    public val thumbnail: ThumbnailDto?,
    public val thumbnailOutline: OutlineDto?,
    ...
    public val emojis: Array<EmojisDto>,
) {
    override fun equals(other: Any?): Boolean {
        ...
        val stickersEquals = other.stickers.contentDeepEquals(stickers)
        if (!stickersEquals) {
            return false
        }
