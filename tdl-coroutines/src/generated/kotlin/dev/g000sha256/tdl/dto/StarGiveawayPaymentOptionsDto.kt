 ...
 */
public class StarGiveawayPaymentOptionsDto public constructor(
    public val options: Array<StarGiveawayPaymentOptionDto>,
) {
    override fun equals(other: Any?): Boolean {
        ...
        other as StarGiveawayPaymentOptionsDto
    ...
    override fun toString(): String {
        return buildString {
            append("StarGiveawayPaymentOptionsDto")
            append("(")
            append("options=")
            options
                .contentDeepToString()
