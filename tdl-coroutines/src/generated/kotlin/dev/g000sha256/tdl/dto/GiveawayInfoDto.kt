 ...
 */
public sealed class GiveawayInfoDto private constructor() {
    /**
     ...
     */
    public class Ongoing public constructor(
        public val creationDate: Int,
        public val status: GiveawayParticipantStatusDto,
        ...
        override fun toString(): String {
            return buildString {
                append("GiveawayInfoDto.Ongoing")
                append("(")
                append("creationDate=")
                append(creationDate)
                append(", ")
     ...
     */
    public class Completed public constructor(
        public val creationDate: Int,
        ...
        override fun toString(): String {
            return buildString {
                append("GiveawayInfoDto.Completed")
                append("(")
                append("creationDate=")
                append(creationDate)
                append(", ")
