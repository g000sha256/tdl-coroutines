 ...
 */
public class SavedMessagesTopicUpdateDto public constructor(
    public val topic: SavedMessagesTopicDto,
) : UpdateDto() {
    override fun equals(other: Any?): Boolean {
        ...
        other as SavedMessagesTopicUpdateDto
    ...
    override fun toString(): String {
        return buildString {
            append("SavedMessagesTopicUpdateDto")
            append("(")
            append("topic=")
            append(topic)
            append(")")
