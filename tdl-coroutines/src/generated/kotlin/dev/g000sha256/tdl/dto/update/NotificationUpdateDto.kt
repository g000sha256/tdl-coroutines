 ...
 */
public class NotificationUpdateDto public constructor(
    public val notificationGroupId: Int,
    public val notification: NotificationDto,
) : UpdateDto() {
    override fun equals(other: Any?): Boolean {
        ...
        other as NotificationUpdateDto
    ...
    override fun hashCode(): Int {
        ...
        hashCode = 31 * hashCode + notification.hashCode()
        return hashCode
    }

    override fun toString(): String {
        return buildString {
            append("NotificationUpdateDto")
            append("(")
