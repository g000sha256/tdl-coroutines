 ...
 */
public class UpgradedGiftOriginalDetailsDto public constructor(
    public val senderId: MessageSenderDto?,
    public val receiverId: MessageSenderDto,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as UpgradedGiftOriginalDetailsDto
    ...
    override fun toString(): String {
        return buildString {
            append("UpgradedGiftOriginalDetailsDto")
            append("(")
            append("senderId=")
            append(senderId)
            append(", ")
