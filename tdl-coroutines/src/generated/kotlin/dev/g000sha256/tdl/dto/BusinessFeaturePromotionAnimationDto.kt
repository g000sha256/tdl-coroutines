 ...
 */
public class BusinessFeaturePromotionAnimationDto public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as BusinessFeaturePromotionAnimationDto
    ...
    override fun toString(): String {
        return buildString {
            append("BusinessFeaturePromotionAnimationDto")
            append("(")
            append("feature=")
            append(feature)
            append(", ")
