 ...
 */
public class MessageReactionUpdateDto public constructor(
    public val chatId: Long,
    public val messageId: Long,
    public val actorId: MessageSenderDto,
    public val date: Int,
    public val oldReactionTypes: Array<ReactionTypeDto>,
    public val newReactionTypes: Array<ReactionTypeDto>,
) : UpdateDto() {
    override fun equals(other: Any?): Boolean {
        ...
        other as MessageReactionUpdateDto
    ...
    override fun toString(): String {
        return buildString {
            append("MessageReactionUpdateDto")
            append("(")
            append("chatId=")
            append(chatId)
            append(", ")
