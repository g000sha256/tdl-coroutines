 ...
 */
public class ChatFolderInviteLinkInfoDto public constructor(
    public val chatFolderInfo: ChatFolderInfoDto,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ChatFolderInviteLinkInfoDto
    ...
    override fun toString(): String {
        return buildString {
            append("ChatFolderInviteLinkInfoDto")
            append("(")
