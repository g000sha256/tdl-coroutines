 ...
 */
public class ChatStatisticsAdministratorActionsInfoDto public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ChatStatisticsAdministratorActionsInfoDto
    ...
    override fun toString(): String {
        return buildString {
            append("ChatStatisticsAdministratorActionsInfoDto")
            append("(")
            append("userId=")
            append(userId)
            append(", ")
