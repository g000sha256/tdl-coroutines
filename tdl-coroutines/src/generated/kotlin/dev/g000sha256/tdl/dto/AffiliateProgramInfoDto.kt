 ...
 */
public class AffiliateProgramInfoDto public constructor(
    public val parameters: AffiliateProgramParametersDto,
    public val endDate: Int,
    public val dailyRevenuePerUserAmount: StarAmountDto,
) {
    override fun equals(other: Any?): Boolean {
        ...
        other as AffiliateProgramInfoDto
    ...
    override fun toString(): String {
        return buildString {
            append("AffiliateProgramInfoDto")
            append("(")
            append("parameters=")
            append(parameters)
            append(", ")
