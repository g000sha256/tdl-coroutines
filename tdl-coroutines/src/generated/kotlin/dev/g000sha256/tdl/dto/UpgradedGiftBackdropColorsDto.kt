 ...
 *
 * @property centerColor A color in the center of the backdrop in the RGB format.
 * @property edgeColor A color on the edges of the backdrop in the RGB format.
 ...
 */
public class UpgradedGiftBackdropColorsDto public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as UpgradedGiftBackdropColorsDto
        ...
        if (other.symbolColor != symbolColor) {
            return false
        }
    ...
    override fun hashCode(): Int {
        ...
        hashCode = 31 * hashCode + symbolColor.hashCode()
    ...
    override fun toString(): String {
        return buildString {
            append("UpgradedGiftBackdropColorsDto")
            append("(")
            append("centerColor=")
            append(centerColor)
            append(", ")
