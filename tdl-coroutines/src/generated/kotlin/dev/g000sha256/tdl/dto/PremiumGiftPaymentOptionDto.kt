 ...
 * @property starCount The alternative amount of Telegram Stars to pay; 0 if payment in Telegram Stars is not possible.
 ...
 */
public class PremiumGiftPaymentOptionDto public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as PremiumGiftPaymentOptionDto
    ...
    override fun toString(): String {
        return buildString {
            append("PremiumGiftPaymentOptionDto")
            append("(")
            append("currency=")
            append(currency)
            append(", ")
