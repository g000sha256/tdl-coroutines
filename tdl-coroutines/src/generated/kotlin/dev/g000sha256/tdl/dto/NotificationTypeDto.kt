 ...
 */
public sealed class NotificationTypeDto private constructor() {
    /**
     ...
     */
    public class NewMessage public constructor(
        ...
        override fun toString(): String {
            return buildString {
                append("NotificationTypeDto.NewMessage")
                append("(")
                append("message=")
                append(message)
                append(", ")
     ...
     */
    public class NewSecretChat public constructor() : NotificationTypeDto() {
        override fun equals(other: Any?): Boolean {
            if (other === this) {
                return true
            }
     ...
     */
    public class NewCall public constructor(
        ...
        override fun toString(): String {
            return buildString {
                append("NotificationTypeDto.NewCall")
                append("(")
                append("callId=")
                append(callId)
                append(")")
    ...
    public class NewPushMessage public constructor(
        ...
        override fun toString(): String {
            return buildString {
                append("NotificationTypeDto.NewPushMessage")
                append("(")
                append("messageId=")
                append(messageId)
                append(", ")
