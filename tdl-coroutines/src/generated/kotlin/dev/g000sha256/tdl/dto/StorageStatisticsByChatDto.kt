 ...
 */
public class StorageStatisticsByChatDto public constructor(
    public val chatId: Long,
    public val size: Long,
    public val count: Int,
    public val byFileType: Array<StorageStatisticsByFileTypeDto>,
) {
    override fun equals(other: Any?): Boolean {
        ...
        other as StorageStatisticsByChatDto
    ...
    override fun toString(): String {
        return buildString {
            append("StorageStatisticsByChatDto")
            append("(")
            append("chatId=")
            append(chatId)
            append(", ")
