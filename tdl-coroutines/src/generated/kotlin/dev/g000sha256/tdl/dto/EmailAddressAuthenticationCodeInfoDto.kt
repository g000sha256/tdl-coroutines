 ...
 */
public class EmailAddressAuthenticationCodeInfoDto public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as EmailAddressAuthenticationCodeInfoDto
    ...
    override fun toString(): String {
        return buildString {
            append("EmailAddressAuthenticationCodeInfoDto")
            append("(")
