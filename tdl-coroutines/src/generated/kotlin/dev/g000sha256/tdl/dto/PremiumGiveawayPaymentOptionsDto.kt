 ...
 */
public class PremiumGiveawayPaymentOptionsDto public constructor(
    public val options: Array<PremiumGiveawayPaymentOptionDto>,
) {
    override fun equals(other: Any?): Boolean {
        ...
        other as PremiumGiveawayPaymentOptionsDto
    ...
    override fun toString(): String {
        return buildString {
            append("PremiumGiveawayPaymentOptionsDto")
            append("(")
            append("options=")
            options
                .contentDeepToString()
