 ...
 */
public class EncryptedPassportElementDto public constructor(
    ...
    public val files: Array<DatedFileDto>,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as EncryptedPassportElementDto
        if (other.type != type) {
            return false
        }
    ...
    override fun toString(): String {
        return buildString {
            append("EncryptedPassportElementDto")
            append("(")
            append("type=")
            append(type)
            append(", ")
