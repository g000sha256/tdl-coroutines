 ...
 *
 * @property id Photo identifier; 0 for an empty photo. Can be used to find a photo in a list of user profile photos.
 * @property small A small (160x160) user profile photo. The file can be downloaded only before the photo is changed.
 * @property big A big (640x640) user profile photo. The file can be downloaded only before the photo is changed.
 * @property minithumbnail User profile photo minithumbnail; may be null.
 ...
 */
public class ProfilePhotoDto public constructor(
    public val id: Long,
