 ...
 */
public class ProfileAccentColorsUpdateDto public constructor(
    public val colors: Array<ProfileAccentColorDto>,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ProfileAccentColorsUpdateDto
    ...
    override fun toString(): String {
        return buildString {
            append("ProfileAccentColorsUpdateDto")
            append("(")
            append("colors=")
            colors
                .contentDeepToString()
