 ...
 */
public class BusinessAwayMessageSettingsDto public constructor(
    public val shortcutId: Int,
    public val recipients: BusinessRecipientsDto,
    public val schedule: BusinessAwayMessageScheduleDto,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as BusinessAwayMessageSettingsDto
    ...
    override fun toString(): String {
        return buildString {
            append("BusinessAwayMessageSettingsDto")
            append("(")
            append("shortcutId=")
            append(shortcutId)
            append(", ")
