 ...
 */
public class ChatRevenueAmountUpdateDto public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ChatRevenueAmountUpdateDto
        if (other.chatId != chatId) {
            return false
        }
        return other.revenueAmount == revenueAmount
    }
    ...
    override fun toString(): String {
        return buildString {
            append("ChatRevenueAmountUpdateDto")
            append("(")
            append("chatId=")
            append(chatId)
            append(", ")
