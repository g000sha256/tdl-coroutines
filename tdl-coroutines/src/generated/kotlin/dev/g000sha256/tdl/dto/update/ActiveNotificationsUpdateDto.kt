 ...
 */
public class ActiveNotificationsUpdateDto public constructor(
    public val groups: Array<NotificationGroupDto>,
) : UpdateDto() {
    override fun equals(other: Any?): Boolean {
        ...
        other as ActiveNotificationsUpdateDto
    ...
    override fun toString(): String {
        return buildString {
            append("ActiveNotificationsUpdateDto")
            append("(")
            append("groups=")
            groups
                .contentDeepToString()
