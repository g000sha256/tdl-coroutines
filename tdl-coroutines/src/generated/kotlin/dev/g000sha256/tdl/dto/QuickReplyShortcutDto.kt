 ...
 */
public class QuickReplyShortcutDto public constructor(
    public val id: Int,
    public val name: String,
    public val firstMessage: QuickReplyMessageDto,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as QuickReplyShortcutDto
        if (other.id != id) {
            return false
        }
        if (other.name != name) {
