 ...
 */
public class UnconfirmedSessionUpdateDto public constructor(
    public val session: UnconfirmedSessionDto?,
) : UpdateDto() {
    override fun equals(other: Any?): Boolean {
        ...
        other as UnconfirmedSessionUpdateDto
    ...
    override fun toString(): String {
        return buildString {
            append("UnconfirmedSessionUpdateDto")
            append("(")
            append("session=")
            append(session)
            append(")")
