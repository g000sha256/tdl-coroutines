 ...
 */
public class AnimationSearchParametersUpdateDto public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as AnimationSearchParametersUpdateDto
    ...
    override fun toString(): String {
        return buildString {
            append("AnimationSearchParametersUpdateDto")
            append("(")
            append("provider=")
            append(provider)
            append(", ")
