 ...
 */
public class AuthenticationCodeInfoDto public constructor(
    public val phoneNumber: String,
    public val type: AuthenticationCodeTypeDto,
    public val nextType: AuthenticationCodeTypeDto?,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as AuthenticationCodeInfoDto
    ...
    override fun toString(): String {
        return buildString {
            append("AuthenticationCodeInfoDto")
            append("(")
            append("phoneNumber=")
            append(phoneNumber)
            append(", ")
