 ...
 */
public class MessageLiveLocationViewedUpdateDto public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as MessageLiveLocationViewedUpdateDto
    ...
    override fun toString(): String {
        return buildString {
            append("MessageLiveLocationViewedUpdateDto")
            append("(")
            append("chatId=")
            append(chatId)
            append(", ")
