 ...
 */
public sealed class ChatBoostSourceDto private constructor() {
    /**
     ...
     */
    public class GiftCode public constructor(
        ...
        override fun toString(): String {
            return buildString {
                append("ChatBoostSourceDto.GiftCode")
                append("(")
                append("userId=")
                append(userId)
                append(", ")
    ...
    public class Giveaway public constructor(
        ...
        override fun toString(): String {
            return buildString {
                append("ChatBoostSourceDto.Giveaway")
                append("(")
                append("userId=")
                append(userId)
                append(", ")
    ...
    public class Premium public constructor(
        ...
        override fun toString(): String {
            return buildString {
                append("ChatBoostSourceDto.Premium")
                append("(")
                append("userId=")
                append(userId)
                append(")")
