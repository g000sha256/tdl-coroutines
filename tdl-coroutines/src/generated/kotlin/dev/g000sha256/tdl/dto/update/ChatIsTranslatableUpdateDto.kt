 ...
 */
public class ChatIsTranslatableUpdateDto public constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as ChatIsTranslatableUpdateDto
        if (other.chatId != chatId) {
            return false
        }
        return other.isTranslatable == isTranslatable
    }
    ...
    override fun toString(): String {
        return buildString {
            append("ChatIsTranslatableUpdateDto")
            append("(")
            append("chatId=")
            append(chatId)
            append(", ")
